...
// in number_trivia/test/features/get_trivia/presentation/number_trivia_bloc.dart.
...
class MockInputConverter extends _i1.Mock implements _i4.InputConverter {
  ...
  @override
  _i2.Either<_i5.Failure, int> stringToUnsignedInteger(String? input) =>
      (super.noSuchMethod(Invocation.method(#stringToUnsignedInteger, [input]),
              returnValue: _FakeEither_0<_i5.Failure, int>(
                  this, Invocation.method(#stringToUnsignedInteger, [input])))
